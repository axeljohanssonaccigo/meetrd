...
function alo_em_show_widget_form ( ) {
	...
	if (is_user_logged_in()) {
        ...
        $html .= "<div id='alo_easymail_widget_feedback'></div>\n";
        $html .= "<form name='alo_easymail_widget_form' id='alo_easymail_widget_form' class='form-inline alo_easymail_widget_form alo_easymail_widget_form_public' method='post' action='' onsubmit='alo_em_pubblic_form();return false;'>\n";
        $html .= $preform_html;        
...
//        $html .= "  </div>\n";
        ...
        //$html .= "</tbody></table>\n";        
 		$html .= $lists_table; // add lists table     
 		$html .= $disclaimer_html;	
        $html .= "<span class='input-group-btn'><input type='submit' name='submit' value='".__("Subscribe", "alo-easymail")."' class='input-submit btn btn-primary' /></span></div>\n";
        $html .= "</form></div>\n";    
    } 
