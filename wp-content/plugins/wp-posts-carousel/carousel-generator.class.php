            ...
            */
            if ( $params['show_featured_image'] === 'true' ) {
                ...
                $featured_image = '<div class="wp-posts-carousel-image">';
                    $featured_image.= '<a href="' . $post_url . '" title="' . __('Läs mer', 'wp-posts-carousel') . ' ' . $post->post_title . '">';
            ...
            */
            if ( $params['show_more_button'] === 'true' ) {
                $buttons = '<p class="wp-posts-carousel-buttons">';
                    $buttons.= '<a href="' . $post_url . '" class="wp-posts-carousel-more-button button" title="' . __('Läs mer', 'wp-posts-carousel') . ' ' . $post->post_title . '">' . __('Läs mer', 'wp-posts-carousel') . '</a>';
                $buttons.= '<p>';
            }
