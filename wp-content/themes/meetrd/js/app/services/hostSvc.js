    ...
    this.updateRoom = function (data, room) {
        return $http({
            ...
            params: {
                ...
                'custom[wpcf-start-time]': room.startTime.slotFloat,
                'custom[wpcf-end-time]': room.endTime.slotFloat,
                'custom[wpcf-street-address]': room.street,
                'custom[wpcf-city]': room.city,
                'custom[wpcf-postal-city]': room.postalCity,
                ...
                'custom[wpcf-cropped-photo]': room.croppedPhoto,
