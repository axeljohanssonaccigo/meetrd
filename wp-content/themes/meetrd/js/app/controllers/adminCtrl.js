...
adminApp.controller('adminCtrl', function($scope, adminSvc) {
	...
	{"id": 1, "status": "Väntar på bekräftelse", "isOpen": false, "bookings": 0},
	{"id": 2, "status": "Bekräftade", "isOpen": false, "bookings": 0},
	{"id": 3, "status": "Nekade", "isOpen": false, "bookings": 0},
	{"id": 4, "status": "Passerade", "isOpen": false, "bookings": 0},
	{"id": 5, "status": "Avbokade", "isOpen": false, "bookings": 0}
	];
	$scope.allBookings = [];
