...
$postalCity = $custom_fields['wpcf-postal-city'][0];
...
?>
    ...
    <script type="text/javascript">
        ...
        var roomPostalCity = '<?php echo $postalCity; ?>';
                                        ...
                                        <div class="booking-options">
                                            ...
                                            <div class="booking-option clearfix" ng-show="datePickerSettings.date.length > 0">
                                                ...
                                                <div class="hours-dropdown-container col-xs-12 col-sm-3 col-md-5">
                                                    <select ng-click="hourSelectWasClicked()" name="hoursDropdown" id="hoursDropdown" ng-options="hour for hour in bookingHoursOptions" ng-model="selectedHoursToBook.value" class="btn btn-primary col-xs-12" style="line-height: 40px; padding-left: 40%; background-color: #325d88;"></select>
                                                </div>
                                            </div>
           ...
           -->
                                    ...
                                    <div class="room-prop clearfix">
                                        ...
                                        <div class="col-xs-7 col-sm-8">
                                            <i class="fa fa-users fa-lg"></i> {{currentRoom.nrOfPeople}} personer
                                        </div>
                                        <div class="col-xs-7 col-xs-offset-5 col-sm-offset-4 col-sm-8">
                                            <i class="fa fa-home fa-lg"></i> {{currentRoom.setting}}
                                        </div>
                                    </div>
                                    <div class="separator"></div>
                                    <!-- <div class="room-prop clearfix">
                                    ...
                                    <div class="room-prop clearfix">
                                        ...
                                        <div class="col-xs-7 col-sm-8">
                                            <div ng-repeat="eq in equipment" ng-class="{isTonedOut: !eq.isChecked}">
                                                <i class="fa fa-check-square-o fa-lg"></i> {{eq.displayName}}
                                            </div>
                                        </div>
                                    </div>
                                    <div class="separator"></div>
                                    <div class="room-prop clearfix">
                                        ...
                                        <div class="col-xs-7 col-sm-8">
                                            <div ng-repeat="food in food" ng-class="{isTonedOut: !food.isChecked}">
                                                <i class="fa fa-check-square-o fa-lg"></i> {{food.displayName}}
                                            </div>
                                        </div>
                                    </div>
